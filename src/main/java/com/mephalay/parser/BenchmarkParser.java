...
public class BenchmarkParser {
    ...
    public static List<GpuBenchmark> parseForPassmarkMidEndGpus() {

        List<GpuBenchmark> retVal = new ArrayList<>();
        try {
            CloseableHttpClient httpClient = HttpClients.createDefault();
            HttpGet getMethod = new HttpGet("http://www.videocardbenchmark.net/mid_range_gpus.html");
            HttpResponse response = httpClient.execute(getMethod);
            BufferedReader rd = new BufferedReader(new InputStreamReader(response.getEntity().getContent()));
            StringBuilder result = new StringBuilder();
            String line = "";
    ...
    public static List<GpuBenchmark> parseForPassmarkLowMidRange() {
        ...
        try {
            CloseableHttpClient httpClient = HttpClients.createDefault();
            HttpGet getMethod = new HttpGet("http://www.videocardbenchmark.net/midlow_range_gpus.html");
            HttpResponse response = httpClient.execute(getMethod);
            BufferedReader rd = new BufferedReader(new InputStreamReader(response.getEntity().getContent()));
            StringBuilder result = new StringBuilder();
            String line = "";
